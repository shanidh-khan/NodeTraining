...
const employeeController = new employee_controller_1.default(new employee_service_1.default(new employee_repository_1.default(data_source_db_1.default.getRepository(employee_entity_1.default))));
