    ...
    constructor(employeeService) {
        ...
        this.createEmployee = (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const employee = yield this.employeeService.createEmployee(employeeDto.name, employeeDto.email, employeeDto.age, employeeDto.address, employeeDto.password, employeeDto.role);
